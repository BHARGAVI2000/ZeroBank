...
public class TC_007 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//add to cart
				...
				Thread.sleep(3000);//click on women
		...
		//4. Select and hover the mouse on t[he item and click on the remove this product from cart icon 
			...
			WebElement item=	driver.findElement(By.xpath("//*[@id=\"header\"]/div[3]/div/div/div[3]/div/a"));
			WebElement image=driver.findElement(By.xpath("//*[@id=\"header\"]/div[3]/div/div/div[3]/div/div/div/div/dl/dt/a/img"));
