...
public class FileUpload_AutoIT3 {
	...
	public void fileUpload() throws AWTException, InterruptedException, IOException {
		driver.findElement(By.xpath("//*[@id='identifierId']")).sendKeys("sarithaaila1@gmail.com");
		driver.findElement(By.xpath("/html//div[@id='identifierNext']")).click();
		String encodepassword= "saritha1";
		...
		Thread.sleep(3000);
		driver.findElement(By.name("to")).sendKeys("saritha740@yahoo.c");
		Thread.sleep(3000);
		driver.findElement(By.name("subjectbox")).sendKeys("Testing File Upload");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//div[@class='a1 aaA aMZ']")).click();
		Thread.sleep(3000);
		Runtime.getRuntime().exec("C:\\Users\\Aila\\eclipse-workspace\\Selenium2-master\\scripts\\fileupload.exe");
